...
public:
  ...
  static bool backup_dir(const std::string& src_dir, const std::string& dst_dir);
  ...
  static int64_t append_file(const std::string& file, std::string& content);
  ...
  static void seekg_last_line(FILE* fp, size_t& pos);

  static void read_last_line(const std::string& filename, std::string& content);
  ...
  static void clear_file(const std::string& filename);
};
